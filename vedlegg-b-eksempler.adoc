== Vedlegg B (ikke-normativt) - eksempler [[vedlegg-b]]
...
Steg 1.2 Virksomhetene undersøker andre kilder (https://snl.no/[Store norske leksikon], https://ordbok.uib.no/[Ordbøkene], https://data.norge.no/concepts[begrepsdelen av Felles dataktalog], https://termportalen.no[Termportalen] og https://termbasen.standard.no/[Termbasen]) og finner en definisjon fra Store norske leksikon:
...
Steg 1.2 Virksomhetene sjekker andre kilder for relevante termer og definisjoner: https://lovdata.no/[Lovdata], https://termbasen.standard.no/[Termbasen], https://snl.no/[Store norske leksikon], https://data.norge.no/concepts[begrepsdelen av Felles datakatalog] og https://termportalen.no[Termportalen].
...
|_kloakk_ (synonym: _avløpsvann_): vann som slippes ut fra husholdninger|_avløpsvann_: brukt vann og alt vann som slippes ut i avløpssystemet, f.eks. husholdnings- og industriavløpsvann, kondensvann samt overvann som slippes ut i avløpssystemet|_avløpsvann_: brukt vann og alt vann som slippes ut i avløpssystemet, f.eks. husholdnings- og industriavløpsvann, kondensvann samt overvann som slippes ut i avløpssystemet
...
Virksomhetene blir enige om at Virksomhet B får ansvaret for å forvalte det nye, felles begrepssystemet. Virksomhet B registrerer begrepene i https://data.norge.no/concepts[begrepsdelen av Felles datakatalog] og forplikter seg til å ta kontakt med virksomhet A ved eventuelle, framtidige begrepsendringer.
...
Steg 1.2 Virksomhetene sjekker andre kilder for relevante termer eller definisjoner: https://lovdata.no/[Lovdata], https://snl.no/[Store norske leksikon], https://data.norge.no/concepts[begrepsdelen av Felles datakatalog], https://oda.uib.no/app?ma=term&mg=uhr[UHRs termbase], https://termportalen.no/[Termportalen], https://ordbok.uib.no/[Ordbøkene], https://naob.no/[NAOB].
...
Begrepene fra de to virksomhetene blir ført opp i samme termbase: https://data.norge.no/concepts[begrepsdelen av Felles datakatalog].
...
Steg 4.5 Det blir lagt inn en _se også_-relasjon mellom begrepene i https://data.norge.no/concepts[begrepsdelen av Felles datakatalog].
...
I Universitets- og høgskolerådets (UHR) termbase finner de synonymet _fulltidsstudent_, men uten definisjon. I tillegg finner de både _fulltidsstudent_ og _heltidsstudent_ i bruk på en del relevante nettsider, bl.a. Statens lånekasse for utdanning. Synonymet blir derfor tatt med i det videre arbeidet.
...
Begrepene blir registrert i samme termbase, i dette tilfellet https://data.norge.no/concepts[begrepsdelen av Felles datakatalog].
...
Steg 4.3 Endring i merknad i definisjon: Virksomhetene ønsker å tydeliggjøre avviket mellom begrepene i merknadsfeltet i https://data.norge.no/concepts[begrepsdelen av Felles datakatalog] på følgende måte:
...
Steg 4.5 Det blir lagt inn en _se også_-begrepsrelasjon mellom begrepene i https://data.norge.no/concepts[begrepsdelen av Felles datakatalog].
