== Vedlegg A (informativt) - utdypende beskrivelse av stegene i prosessmodell  [[vedlegg-a]]
...
* Ved å legge til et ordledd til en eller flere av termene, f.eks. _godtgjørelse_ > +++<u>+++_reise_+++</u>+++_godtgjørelse_
