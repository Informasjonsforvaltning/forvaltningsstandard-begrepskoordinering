...
==== Tips
Punkt 2::
Nyttige kilder til definisjoner og termer: https://lovdata.no/[Lovdata], https://data.norge.no/concepts[begrepsdelen av Felles datakatalog], https://snl.no/[Store norske leksikon], https://termbasen.standard.no/[Termbasen], https://termportalen.no/[Termportalen] og https://nfm.sdlproducts.com/multiterm[Utenriksdepartementets EU-base] (sistnevnte krever pålogging: brukernavn: guest passord: guest). https://ordbokene.no/[_Ordbøkene_] og https://www.naob.no/[_Det Norske Akademis Ordbok_] finnes også, men disse inneholder hovedsakelig begreper fra allmennspråket.
...
Det finnes også internasjonale kilder, f.eks. EUs termbase https://iate.europa.eu/home[IATE] og https://www.iso.org/obp/ui/[ISO Online Browsing Platform (OBP)] eller sektorspesifikke baser som f.eks. http://www.electropedia.org/[Electropedia] for elektroteknikk og https://home-affairs.ec.europa.eu/networks/european-migration-network-emn/emn-asylum-and-migration-glossary_en[EMN Asylum and Migration Glossary] for asyl og migrasjon.

Punkt 3::
 Dere kan bruke et vanlig hvitt ark eller et program til å tegne begrepsdiagram. https://data.norge.no/specification/termlosen[_Termlosen_] gir en innføring i begrepsdiagram og inndelingskriterium.

Punkt 4::
 Se også her https://data.norge.no/specification/termlosen[_Termlosen_].
...
For statlige virksomheter finnes https://dfo.no/fagomrader/utredning-og-analyse-av-statlige-tiltak[_Utredningsinstruksen_] som gir føringer for analyse av administrative og økonomiske konsekvenser.
...
Deltakerne bør ta kontakt med relevante organer om de planlegger å revidere standarder: https://www.standard.no/standarder-pa-horing/[Standard.no], https://www.nek.no/[Nek.no] og https://www.nkom.no/[Nkom.no], https://www.digdir.no/digitalisering-og-samordning/utredning-av-nye-krav-til-standarder/1472[Digitaliseringsdirektoratet], https://www.cen.eu/Pages/default.aspx[den europeiske standardiseringsorganisasjonen CEN] og https://www.iso.org/home.html[den internasjonale standardiseringsorganisasjonen ISO].
