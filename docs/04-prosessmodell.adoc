...
Standarden forutsetter at omfanget er avgrenset og begrepene er definert og beskrevet i henhold til https://doc.difi.no/data/forvaltningsstandard-begrepsbeskrivelser/[_Forvaltningsstandard for begrepsbeskrivelser_]. Dersom ikke det er gjort, bør dere gå til forarbeid (<<vedlegg-c, vedlegg C>>, ikke-normativt).
