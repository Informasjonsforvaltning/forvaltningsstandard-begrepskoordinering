== Vedlegg C (ikke-normativt) - Forarbeid før denne standarden brukes [[vedlegg-c]]
...
Eksempel: Opplysningene skal ikke gi svar på hvor mange studenter som mottar studielån, hvor mange som har søkt på et studium og hvor mange som har permisjon fra studiene.
...
https://www.prosjektveiviseren.no/god-praksis/viktige-tema-i-alle-faser/interessenter[_Prosjektveiviseren_] gir en god veiledning på interessentanalyse:
...
==== Forslag til framgangsmåte
https://www.prosjektveiviseren.no/[_Prosjektveiviseren_] gir en god veiledning om bl.a. prosjektorganisering.
...
https://www.digdir.no/digitalisering-og-samordning/begrepsanalyse-og-definisjonsarbeid/1483[_Referansekatalogen_] inneholder relevante standarder for begrepsanalyse og definisjonsarbeid, inkl. _Termlosen_.

https://termbasen.standard.no/[Termbasen til Standard Norge] inneholder en rekke definisjoner av sentrale begreper i terminologi og terminologiarbeid.
